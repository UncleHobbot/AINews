    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-10 w-full max-w-sm text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Your personal AI-powered news feed</p>
        </div>
        <a
          href={authApi.loginUrl()}
          className="flex items-center justify-center gap-3 w-full px-4 py-3 bg-white border border-gray-200 rounded-xl
        ...
        <p className="text-xs text-gray-400">Access restricted to authorized accounts</p>
      </div>
    </div>
  )
}
